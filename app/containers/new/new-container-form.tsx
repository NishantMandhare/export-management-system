...
import { createContainerAction } from "@/lib/actions";
...
export default function NewContainerForm({
    ...
    function addLineItem() {
        setLineItems([...lineItems, { orderItemId: "", quantityAssigned: "" }]);
    }
                ...
                <CardContent>
                    <form action={formAction} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <Input id="containerNumber" name="containerNumber" required />
                        </div>

                        <div className="space-y-2">
                            <Label htmlFor="blNumber">BL Number</Label>
                            <Input id="blNumber" name="blNumber" required />
                        </div>
                        ...
                        <Button type="submit" className="w-full" disabled={isPending}>
                            {isPending ? "Saving..." : "Save Container"}
                        </Button>
                    </form>
                </CardContent>
            </Card>
